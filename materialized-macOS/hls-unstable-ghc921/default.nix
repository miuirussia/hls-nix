  ...
  pkgs = hackage:
    {
      packages = {
        ...
        "retrie".revision = (((hackage."retrie")."1.2.0.0").revisions).default;
        ...
        "monoid-subclasses".revision = (((hackage."monoid-subclasses")."1.1.2").revisions).default;
        "ghc-paths".revision = (((hackage."ghc-paths")."0.1.0.12").revisions).default;
        "ormolu".revision = (((hackage."ormolu")."0.3.1.0").revisions).default;
        ...
        "ghc-exactprint".revision = (((hackage."ghc-exactprint")."1.3.0").revisions).default;
        ...
        "diagrams-lib".revision = (((hackage."diagrams-lib")."1.4.5.1").revisions).default;
        ...
        "primitive-extras".revision = (((hackage."primitive-extras")."0.10.1.3").revisions).default;
        ...
        "lsp-types".revision = (((hackage."lsp-types")."1.4.0.0").revisions).default;
        ...
        "record-dot-preprocessor".revision = (((hackage."record-dot-preprocessor")."0.2.13").revisions).default;
        ...
        "ghc-lib".revision = (((hackage."ghc-lib")."9.0.2.20211226").revisions).default;
    ...
    ({ lib, ... }:
      {
        packages = {
          ...
          "hls-hlint-plugin" = {
            flags = {
              "hlint33" = lib.mkOverride 900 true;
