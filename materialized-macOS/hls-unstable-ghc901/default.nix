  ...
  pkgs = hackage:
    {
      packages = {
        ...
        "hlint".revision = (((hackage."hlint")."3.3.1").revisions).default;
  ...
  extras = hackage:
    {
      packages = {
        ...
        operational = ./.plan.nix/operational.nix;
        ...
        dependent-sum-template = ./.plan.nix/dependent-sum-template.nix;
        czipwith = ./.plan.nix/czipwith.nix;
        ...
        blaze-textual = ./.plan.nix/blaze-textual.nix;
    ...
    ({ lib, ... }:
      {
        packages = {
          ...
          "operational" = {
            flags = { "buildexamples" = lib.mkOverride 900 true; };
            };
          "th-extras" = { flags = { "base4" = lib.mkOverride 900 true; }; };
          "hls-class-plugin" = { flags = {}; };
          "hls-eval-plugin" = {
            flags = { "pedantic" = lib.mkOverride 900 false; };
            };
          "hls-pragmas-plugin" = { flags = {}; };
          "dependent-sum-template" = { flags = {}; };
          "czipwith" = { flags = {}; };
          "ghcide" = {
            flags = {
          ...
          "blaze-textual" = {
            flags = {
              "native" = lib.mkOverride 900 true;
              "integer-simple" = lib.mkOverride 900 false;
              "developer" = lib.mkOverride 900 false;
              };
            };
