  ...
  extras = hackage:
    {
      packages = {
        ...
        hls-selection-range-plugin = ./.plan.nix/hls-selection-range-plugin.nix;
    ...
    ({ lib, ... }:
      {
        packages = {
          ...
          "hls-selection-range-plugin" = { flags = {}; };
    ...
    ({ lib, ... }:
      {
        packages = {
          ...
          "hls-selection-range-plugin".components.tests."tests".planned = lib.mkOverride 900 true;
